...
export const demoCases: Record<string, DemoCase> = {
  ...
  schema: { name: 'identifier changes schema', code: 'TYPE', finding: 'An identifier type differs in the bundled sample.', heuristic: 'Plan warnings ask for review. They do not decide pass or fail.' },
